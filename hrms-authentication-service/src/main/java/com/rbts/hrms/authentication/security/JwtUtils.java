package com.rbts.hrms.authentication.security;
...
//
//        UsersService userPrincipal = (UsersService) authentication.getPrincipal();
//
//        return Jwts.builder()
...
//
    ...
    public String generateJwtToken(UsersService userPrincipal) {
